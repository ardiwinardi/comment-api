...
const models: TsoaRoute.Models = {
    ...
    "CommentOrderBy": {
        "dataType": "refEnum",
        "enums": ["most-liked","most-disliked","newest"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "CreateCommentDTO": {
        "dataType": "refObject",
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/auth/me',
            ...
            async function AuthController_getMe(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/auth/login',
            ...
            const args = {
                    payload: {"in":"body","name":"payload","required":true,"ref":"LoginDTO"},
            };
        ...
        app.post('/auth/register',
            ...
            async function AuthController_register(request: any, response: any, next: any) {
            const args = {
                    payload: {"in":"body","name":"payload","required":true,"ref":"RegisterDTO"},
            };
        ...
        app.get('/comments',
            ...
            ...(fetchMiddlewares<RequestHandler>(CommentsController.prototype.getAll)),
        ...
        app.get('/comments/:id',
            ...
            ...(fetchMiddlewares<RequestHandler>(CommentsController)),
            ...(fetchMiddlewares<RequestHandler>(CommentsController.prototype.getById)),

            async function CommentsController_getById(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/comments/:id/react',
            ...
            async function CommentsController_addReaction(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
